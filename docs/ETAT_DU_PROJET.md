...
| Build de test `1.0.54` iOS (54) / Android (69) depuis `master` (c31ed53 : Musculation M1 #289 + J1 #292 + M2 #293, repli snapshot muscu #294, carte Séance alignée metcon #295, contraste « Série suivante » #296) — `verify:ipa` 21/21, `verify:aab` 23/23, bundle Hermes contenant `WodGenerator`, `WodResult` et la discipline `musculation`, `engineCrossFit` absent ; IPA soumis à App Store Connect (TestFlight interne, submission `db8aa3a3`), AAB non envoyé sur Play. Builds EAS `2b624c46` (iOS) / `6b1c3430` (Android). **Migrations `20261214`–`20261217` non appliquées en prod à cette date** (après « 1.0.54 installé »). `app.json` 1.0.54 / 54 / 69 commité | 16 septembre 2026 |

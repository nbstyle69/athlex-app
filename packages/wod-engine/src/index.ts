...
export {
  generateMuscu, priorityFor, targetAvailable, availableTargets, availableDurations, renderMuscu, exerciseLine, loadText, muscuSignature, afterClassMuscles, muscuLevelFor, percentForReps, sessionSeconds,
